...
import { uniRanking } from "@/src/data/uniRanking";
      ...
      <div className="w-full">
        ...
        <div className="divide-y divide-gray-50">
          {uniRanking.map((uni) => (
            <div
              key={uni.id}
              className="grid grid-cols-12 gap-4 py-6 items-center group"
            >
              ...
              <div className="col-span-5 flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-white shadow-sm border border-gray-100 p-1.5 shrink-0">
              ...
              <div className="col-span-2 text-right">
                <span className="px-4 py-1.5 rounded-lg border-2 border-brand-primary/20 text-brand-primary text-xs font-bold inline-block min-w-15 text-center">
                  {uni.employmentRate}%
                </span>
              </div>
            </div>
