...
const PromoBanner = () => {
  ...
  return (
    <div className="relative w-full bg-brand-primary rounded-[40px] overflow-hidden min-h-85 flex items-center shadow-2xl shadow-black/5 transition-all duration-500">
      {!isVideoPlaying ? (
        <>
          ...
          <div className="relative z-10 max-w-lg p-12 animate-in fade-in duration-500">
            ...
            <p className="text-white/80 text-lg mb-10 max-w-85 leading-relaxed">
          ...
          <div className="absolute right-15 bottom-5 h-full w-1/2 select-none pointer-events-none">
            <Image
              ...
              className="object-contain object-bottom-right scale-90 origin-bottom-right"
            />
          </div>
        </>
      ) : (
