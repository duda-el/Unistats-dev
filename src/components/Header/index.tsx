...
const Header = () => {
  ...
  return (
    <header className="h-20 bg-white/80 backdrop-blur-md fixed top-0 right-0 left-0 lg:left-64 z-99999 px-8 flex items-center justify-between border-b border-gray-50">
