...
const Header = () => {
  return (
    <header className="h-20 bg-white backdrop-blur-md fixed top-0 right-0 left-64 z-10 px-8 flex items-center justify-between">
      <h2 className="text-2xl font-bold text-black">მთავარი</h2>
